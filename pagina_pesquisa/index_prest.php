        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <div class="btn-group dropstart ">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
              <li><a class="dropdown-item" href="../perfil/mperfil/index_prest.php">Meu Perfil</a></li>
...
<!-- Fim Navegação -->
  ...
  <main>
    ...
    <div class="container py-5">
      ...
      $sql_code = "SELECT nome, profissao, carreira, celular, email, id FROM prestador_servicos WHERE profissao LIKE '%".$pesquisa_prof."%'";
      $result = mysqli_query($conexao, $sql_code);
